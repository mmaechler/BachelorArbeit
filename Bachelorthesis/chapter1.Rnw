...
<<nor1mixEx, include=FALSE, fig=TRUE,echo=FALSE,results=hide>>=
    ...
    p.EMsteps(20, x9, nm1, plotIni=TRUE, sec.sleep=0, main=NULL, doNote=FALSE, showLik=FALSE)
@

<<plotemsteps,echo=FALSE,include=FALSE,results=hide>>=
    r <- p.EMsteps(200, x9, nm1, main=NULL, doNote=FALSE, showLik=FALSE)
@
...
plot(r$logLik, type = "l", xlab = "iter")

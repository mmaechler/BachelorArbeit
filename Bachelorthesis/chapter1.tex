...
% it 1
In this thesis we restrict ourselves to multivariate normal mixtures.
normal gives easy param ov cov mats
multivariate builds on work done in the nor1mix package.
...
implementations use some form of preclustering and use the EM-algorithm as
